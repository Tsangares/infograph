...
class Scene1_WrongAnswer(Scene):
    def construct(self):
        ...
        self.play(FadeIn(pill, scale=1.05), run_time=0.45)           # +50%
        self.add(ground)
        self.play(
            LaggedStart(*[FadeIn(m, scale=0.9) for m in row], lag_ratio=0.06),
            run_time=1.2,                                             # +50%
        )
        self.play(FadeIn(frame), FadeIn(frame_label), run_time=0.6)  # +50%

        # "cautionary tale" lands ~2.5s into narration
        self.wait(0.6)
        self.play(FadeIn(title, scale=1.12), run_time=0.6)           # +50%
        self.play(FadeIn(title2, scale=1.12), run_time=0.6)          # +50%
        self.play(Flash(title.get_center(), color=GOLD, line_length=0.3, num_lines=8, run_time=0.3))
        ...
        self.play(FadeIn(collapse_text, shift=UP * 0.08), run_time=0.75)  # +50%
        self.wait(0.5)
        self.play(FadeIn(stamp, scale=1.4), run_time=0.3)            # +50%
        self.play(Flash(stamp.get_center(), color=RED, line_length=0.3, num_lines=8, run_time=0.3))
        # Hold to fill 8.50s  (anim total=7.5, need +1.0)
        self.wait(1.0)
...
class Scene2_Contradiction(Scene):
    def construct(self):
        ...
        ).move_to(timeline.get_center() + LEFT * 2 + UP * 1.1)
        deforest_lbl = safe_text("FORESTS GONE", font="Inter", font_size=20, color=RED, weight="BOLD")
        deforest_lbl.next_to(deforest_bar, UP, buff=0.15)
        ...
        self.play(FadeIn(pill, scale=1.05), run_time=0.45)           # +50%
        self.play(FadeIn(problem, scale=1.05), run_time=0.6)         # +50%
        ...
        self.play(FadeIn(deforest_bar), FadeIn(deforest_lbl), run_time=0.45)  # +50%
        self.play(FadeIn(survive_bar), FadeIn(survive_lbl), run_time=0.45)    # +50%
        self.play(GrowArrow(gap_arrow), FadeIn(gap_lbl), run_time=0.3)

        # Payoff
        self.play(Create(div), run_time=0.3)
        self.play(FadeIn(survived, scale=1.1), run_time=0.6)         # +50%
        self.play(FadeIn(sub, shift=UP * 0.06), run_time=0.45)       # +50%
        self.play(FadeIn(lone_moai, scale=0.9), run_time=0.45)       # +50%

        # Hold to fill 5.80s  (anim total=4.95, need +0.85)
        self.wait(0.85)
...
class Scene3_OralTradition(Scene):
    def construct(self):
        ...
        self.play(FadeIn(pill, scale=1.05), run_time=0.45)           # +50%
        self.add(horizon)
        self.play(FadeIn(moai, scale=0.95), run_time=0.9)            # +50%
        self.play(FadeIn(oral, shift=UP * 0.08), run_time=0.75)      # +50%
        self.play(FadeIn(oral2, shift=UP * 0.08), run_time=0.75)     # +50%
        ...
        self.play(FadeIn(ships_text, scale=1.15), run_time=0.6)      # +50%
        self.play(Flash(ships_text.get_center(), color=RED, line_length=0.4, num_lines=10, run_time=0.3))

        # 4.4s: "Then people disappeared."
        self.play(FadeIn(vanished, shift=UP * 0.06), run_time=0.75)  # +50%
        self.play(Create(div), run_time=0.3)

        # Hold to fill 6.50s  (anim total=5.65, need +0.85)
        self.wait(0.85)
...
class Scene4_Proof(Scene):
    def construct(self):
        ...
        self.play(FadeIn(pill, scale=1.05), run_time=0.45)           # +50%
        self.play(FadeIn(date, scale=1.3), run_time=0.6)             # +50%
        self.play(Flash(date.get_center(), color=RED, line_length=0.5, num_lines=10, run_time=0.3))
        ...
        self.play(FadeIn(seized_pre, shift=UP * 0.06), run_time=0.6)  # +50%
        self.play(FadeIn(seized_num, scale=1.15), run_time=0.6)       # +50%
        self.play(Flash(seized_num.get_center(), color=GOLD, line_length=0.4, num_lines=8, run_time=0.3))
        self.play(FadeIn(seized_post, shift=UP * 0.06), run_time=0.45)  # +50%
        ...
        self.play(Create(div), run_time=0.3)
        self.play(FadeIn(smallpox, scale=1.05), run_time=0.6)        # +50%
        self.play(FadeIn(survivors, scale=1.05), run_time=0.6)        # +50%
        self.play(Flash(smallpox.get_center(), color=RED, line_length=0.3, num_lines=8, run_time=0.3))

        # Hold to fill 8.40s  (anim total=7.3, need +1.1)
        self.wait(1.1)
...
class Scene5_Scale(Scene):
    def construct(self):
        ...
        self.play(GrowArrow(drop_arrow), FadeIn(pct, scale=1.1), run_time=0.4)
        self.play(Flash(pct.get_center(), color=RED, line_length=0.3, num_lines=6, run_time=0.3))
        ...
        self.play(FadeIn(fig_after, scale=0.5), run_time=0.3)        # +50%

        # 3.7s: "In less than a decade."
        self.wait(0.2)
        self.play(Create(div), run_time=0.3)
        self.play(FadeIn(decade, scale=1.08), run_time=0.75)         # +50%
        self.play(Flash(decade.get_center(), color=WHITE_SOFT, line_length=0.3, num_lines=8, run_time=0.3))

        # Hold to fill 5.60s  (anim total=5.2, need +0.4)
        self.wait(0.4)
...
class Scene6_Punch(Scene):
    def construct(self):
        ...
        # Animate — synced to narration (extended to ~10s for silence after closer)
        # 0.0s: "We spent a century blaming them for their own extinction."
        self.play(Create(div1), run_time=0.3)
        self.play(FadeIn(line1, shift=UP * 0.08), run_time=0.75)     # +50%
        self.play(FadeIn(line2, shift=UP * 0.08), run_time=0.75)     # +50%
        self.play(FadeIn(line3, shift=UP * 0.08), run_time=0.9)      # +50%
        ...
        self.wait(0.1)
        self.play(FadeIn(cause, shift=UP * 0.06), run_time=0.9)      # +50%

        # 5.6s: "It was us."
        self.wait(0.6)
        self.play(FadeIn(glow), FadeIn(closer, scale=1.08), run_time=1.2)  # +50%
        self.play(FadeIn(sig, scale=0.8), run_time=0.3)              # +50%

        # Extended hold — 3s of silence after "It was us." before fade
        self.wait(2.5)
        black = Rectangle(width=12, height=20, fill_color=BLACK, fill_opacity=1, stroke_width=0)
        self.play(FadeIn(black), run_time=1.2)                       # slower fade
...
def render_single_scene(scene_idx):
    ...
    config.output_file = f"history_final_scene_{scene_idx + 1}"
    config.media_dir = str(output_dir / "media")
    SC().render()
    for mp4 in Path(config.media_dir).rglob(f"history_final_scene_{scene_idx + 1}.mp4"):
...
if __name__ == "__main__":
    ...
    files = parallel_render_scenes(__file__, scene_count=6, topic="history_final")
    final = output_dir / "easter_island_history_manim.mp4"
    concat_scenes(files, str(audio), str(final))
